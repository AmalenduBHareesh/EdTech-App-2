...
class Verifyacc22 extends StatelessWidget {
  const Verifyacc22({Key? key}) : super(key: key);
    ...
    return Scaffold(
              ...
              IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Verifyacc()));
                },
                icon: const Icon(
                  Icons.arrow_back,
                  color: Colors.black,
        ...
        body: Column(
          ...
          children: [
            ...
            const Text('akshayashokanpothan@imiot.co.in',
                style: TextStyle(
