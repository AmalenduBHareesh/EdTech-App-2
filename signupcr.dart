...
import 'package:share_info_main/verifyacc.dart';

class SignUpcr extends StatefulWidget {
  const SignUpcr({Key? key}) : super(key: key);
  @override
  State<SignUpcr> createState() => _SignUpcrState();
}

class _SignUpcrState extends State<SignUpcr> {
      ...
      body: Column(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const Verifyacc()));
            },
            child: Container(
              decoration: BoxDecoration(
                  shape: BoxShape.rectangle,
